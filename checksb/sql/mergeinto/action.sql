-- Query M1: Update 'pending' orders to 'completed'
...
-- Query M2: Update quantities based on user and asset type sums
...
-- Query M3: Archive orders created before 2022-01-01
...
-- Query M4: Randomly swap 'buy' and 'sell' order types
MERGE INTO orders USING (
...
-- Query M5: Increase each order's quantity by 10
...
-- Query M6: Duplicate orders with new IDs
MERGE INTO orders USING (
...
-- Query M7: Update orders with joined average quantities
MERGE INTO orders USING (
...
-- Query M8: Update status for orders between 2021-01-01 and 2021-06-30
...
-- Query M9: Update status based on quantity vs average
MERGE INTO orders USING (
...
-- Query M10: Update price based on average asset value
MERGE INTO orders USING (
