...
COPY INTO customer_address
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/customer_address/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO customer_demographics
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/customer_demographics/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO date_dim
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/date_dim/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO warehouse
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/warehouse/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO ship_mode
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/ship_mode/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO time_dim
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/time_dim/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO reason
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/reason/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO income_band
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/income_band/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO item
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/item/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO store
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/store/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO call_center
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/call_center/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO customer
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/customer/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO web_site
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/web_site/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO store_returns
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/store_returns/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO household_demographics
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/household_demographics/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO web_page
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/web_page/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO promotion
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/promotion/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO catalog_page
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/catalog_page/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO inventory
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/inventory/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO catalog_returns
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/catalog_returns/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO web_returns
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/web_returns/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO web_sales
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/web_sales/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO catalog_sales
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/catalog_sales/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);

COPY INTO store_sales
    FROM 's3://redshift-downloads/TPC-DS/2.13/100GB/store_sales/'
    FILE_FORMAT = (TYPE = CSV, FIELD_DELIMITER = '|', COMPRESSION=AUTO);
